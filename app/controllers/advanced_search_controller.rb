class AdvancedSearchController < ApplicationController
  ...
  def index
    ...
    if new_search
      ...
      append_advanced_user_criteria('created_by', params[:created_by_value], @user_details_criteria_list)
      append_advanced_user_criteria('updated_by', params[:updated_by_value], @user_details_criteria_list)
  ...
  def append_advanced_user_criteria(key, value, list)
    if (value)
      advanced_user_criteria = SearchCriteria.create_advanced_criteria({:field => key, :value => value, :index => 12})
